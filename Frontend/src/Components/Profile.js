                            ...
                            <div className="card shadow mt-3 fillOutPage">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className='d-flex justify-content-end'>
                                        ...
                                        <a className='btn btn-success' href={`http://122.169.207.194:9094/rsinsurance/property/api/v1/create/${detail.paymentDetail.paymentId}`} download='invoice' target='_blank'>
